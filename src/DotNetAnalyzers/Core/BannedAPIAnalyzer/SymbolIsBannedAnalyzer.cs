...
namespace DotNetAnalyzers.BannedApiAnalyzer
{
    internal static class SymbolIsBannedAnalyzer
    {
        ...
        public static readonly DiagnosticDescriptor SymbolIsBannedRule = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.SymbolIsBannedTitle,
            messageFormat: DotNetAnalyzersResources.SymbolIsBannedMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            description: DotNetAnalyzersResources.SymbolIsBannedDescription,
        ...
        public static readonly DiagnosticDescriptor DuplicateBannedSymbolRule = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.DuplicateBannedSymbolTitle,
            messageFormat: DotNetAnalyzersResources.DuplicateBannedSymbolMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            description: DotNetAnalyzersResources.DuplicateBannedSymbolDescription,
            customTags: WellKnownDiagnosticTags.Telemetry);
    }

...
namespace DotNetAnalyzers.PublicApiAnalyzer
{
    ...
    public sealed partial class DeclarePublicAPIAnalyzer : DiagnosticAnalyzer
    {
        ...
        internal static readonly DiagnosticDescriptor DeclareNewApiRule = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.DeclarePublicApiTitle,
            messageFormat: DotNetAnalyzersResources.DeclarePublicApiMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            description: DotNetAnalyzersResources.DeclarePublicApiDescription,
        ...
        internal static readonly DiagnosticDescriptor RemoveDeletedApiRule = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.RemoveDeletedApiTitle,
            messageFormat: DotNetAnalyzersResources.RemoveDeletedApiMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            description: DotNetAnalyzersResources.RemoveDeletedApiDescription,
            customTags: WellKnownDiagnosticTags.Telemetry);
        ...
        internal static readonly DiagnosticDescriptor ExposedNoninstantiableType = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.ExposedNoninstantiableTypeTitle,
            messageFormat: DotNetAnalyzersResources.ExposedNoninstantiableTypeMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            customTags: WellKnownDiagnosticTags.Telemetry);
        ...
        internal static readonly DiagnosticDescriptor PublicApiFilesInvalid = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.PublicApiFilesInvalidTitle,
            messageFormat: DotNetAnalyzersResources.PublicApiFilesInvalidMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            customTags: WellKnownDiagnosticTags.Telemetry);
        ...
        internal static readonly DiagnosticDescriptor DuplicateSymbolInApiFiles = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.DuplicateSymbolsInPublicApiFilesTitle,
            messageFormat: DotNetAnalyzersResources.DuplicateSymbolsInPublicApiFilesMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            customTags: WellKnownDiagnosticTags.Telemetry);
        ...
        internal static readonly DiagnosticDescriptor AvoidMultipleOverloadsWithOptionalParameters = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.AvoidMultipleOverloadsWithOptionalParametersTitle,
            messageFormat: DotNetAnalyzersResources.AvoidMultipleOverloadsWithOptionalParametersMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
        ...
        internal static readonly DiagnosticDescriptor OverloadWithOptionalParametersShouldHaveMostParameters = new DiagnosticDescriptor(
            ...
            title: DotNetAnalyzersResources.OverloadWithOptionalParametersShouldHaveMostParametersTitle,
            messageFormat: DotNetAnalyzersResources.OverloadWithOptionalParametersShouldHaveMostParametersMessage,
            category: "ApiDesign",
            defaultSeverity: DiagnosticHelpers.DefaultDiagnosticSeverity,
            isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
            helpLinkUri: @"https://github.com/dotnet/roslyn/blob/master/docs/Adding%20Optional%20Parameters%20in%20Public%20API.md",

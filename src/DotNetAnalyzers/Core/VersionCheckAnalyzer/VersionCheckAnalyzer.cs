...
namespace DotNetAnalyzers.VersionCheckAnalyzer
{
    ...
    public sealed class AnalyzerVersionCheckAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString s_localizableTitle = new LocalizableResourceString(nameof(DotNetAnalyzersResources.VersionCheckTitle), DotNetAnalyzersResources.ResourceManager, typeof(DotNetAnalyzersResources));
        private static readonly LocalizableString s_localizableMessageFormat = new LocalizableResourceString(nameof(DotNetAnalyzersResources.VersionCheckMessage), DotNetAnalyzersResources.ResourceManager, typeof(DotNetAnalyzersResources));
        private static readonly LocalizableString s_localizableDescription = new LocalizableResourceString(nameof(DotNetAnalyzersResources.VersionCheckDescription), DotNetAnalyzersResources.ResourceManager, typeof(DotNetAnalyzersResources));
...
#pragma warning restore RS1013 // Start action has no registered non-end actions.
            {
                compilationStartContext.RegisterCompilationEndAction(compilationContext =>
                {
                    if (!s_ShouldExecuteAnalyzers)
                    {
                        ...
                        var arg2 = s_ShouldExecuteAnalyzers;

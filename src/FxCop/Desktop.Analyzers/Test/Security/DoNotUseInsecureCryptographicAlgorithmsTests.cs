...
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
...
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderWithGetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
   ...
   class TestClass1
    {
        public MD5 GetMD5
        {
            get { return new MD5CryptoServiceProvider(); }
        }
    }
}",
            GetCSharpResultAt(9, 26, CA5350RuleName, CA5350Message));
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderWithSetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        public MD5 GetMD5
        {
            ...
            {
                if (value == null)
                    privateMd5 = new MD5CryptoServiceProvider();
                else
                    privateMd5 = value;
            }
        }
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderWithFieldInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        MD5CryptoServiceProvider privateMd5 = new MD5CryptoServiceProvider();
    }
}",
            GetCSharpResultAt(7, 47, CA5350RuleName, CA5350Message));
        }        
        
        [Fact]
		public void UseMD5CryptoServiceProviderWithListCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        List<MD5CryptoServiceProvider> md5List = new List<MD5CryptoServiceProvider>() { new MD5CryptoServiceProvider() };
    }
}",
            GetCSharpResultAt(8, 89, CA5350RuleName, CA5350Message));
        }        
        
        [Fact]
		public void UseMD5CryptoServiceProviderWithArrayCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        MD5CryptoServiceProvider[] md5List = new MD5CryptoServiceProvider[] { new MD5CryptoServiceProvider() };
    }
}",
            GetCSharpResultAt(7, 79, CA5350RuleName, CA5350Message));
        }        
        
        [Fact]
		public void UseMD5CryptoServiceProviderWithDictionaryInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        Dictionary<int, MD5CryptoServiceProvider> md5List = new Dictionary<int, MD5CryptoServiceProvider>() { { 1, new MD5CryptoServiceProvider() } };
    }
}",
            GetCSharpResultAt(8, 116, CA5350RuleName, CA5350Message));
        }        
        
        [Fact]
		public void UseMD5CryptoServiceProviderInTryBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderInCatchBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        {
            try { }
            catch (Exception) { var md5 = new MD5CryptoServiceProvider(); }
            finally { }
        }
    }
}",
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderInFinallyBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        private void TestMethod()
        {
            ...
            finally { var md5 = new MD5CryptoServiceProvider(); }
        }
    }
}",
            GetCSharpResultAt(12, 33, CA5350RuleName, CA5350Message));
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderAwaitShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
using System.Threading.Tasks;
namespace TestNamespace
{
    class TestClass
    {
        private async Task TestMethod()
        {
            await Task.Run(() => { new MD5CryptoServiceProvider(); });
        }
        private async void TestMethod2()
        {
            await TestMethod();
        ...
        [Fact]
		public void UseMD5CryptoServiceProviderWithDelegateShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    ...
    {
        delegate void Del();
        Del d = delegate () { new MD5CryptoServiceProvider(); };
    }
}",
            GetCSharpResultAt(8, 31, CA5350RuleName, CA5350Message));
        }        
...
End Module",
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
...
namespace TestNamespace
{
    class TestClass
    {
        private static void TestMethod()
        {
            var rc2 = new SHA1CryptoServiceProvider();
        }
    }
}",
            GetCSharpResultAt(10, 23, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CryptoServiceProviderWithGetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
   class TestClass1
    {
        public SHA1CryptoServiceProvider GetSHA1
        {
            get { return new SHA1CryptoServiceProvider(); }
        }
    }
}",
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderWithSetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1CryptoServiceProvider privateSHA1;
        public SHA1CryptoServiceProvider GetSHA1
        {
            set
            {
                if (value == null)
                    privateSHA1 = new SHA1CryptoServiceProvider();
                else
                    privateSHA1 = value;
            }
        }
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderWithFieldInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1CryptoServiceProvider privateSHA1 = new SHA1CryptoServiceProvider();
    }
}",
            GetCSharpResultAt(7, 49, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CryptoServiceProviderWithListCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        List<SHA1CryptoServiceProvider> SHA1List = new List<SHA1CryptoServiceProvider>() { new SHA1CryptoServiceProvider() };
    }
}",
            GetCSharpResultAt(8, 92, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CryptoServiceProviderWithArrayCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1CryptoServiceProvider[] SHA1List = new SHA1CryptoServiceProvider[] { new SHA1CryptoServiceProvider() };
    }
}",
            GetCSharpResultAt(7, 82, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CryptoServiceProviderWithDictionaryInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        Dictionary<int, SHA1CryptoServiceProvider> SHA1List = new Dictionary<int, SHA1CryptoServiceProvider>() { { 1, new SHA1CryptoServiceProvider() } };
    }
}",
            GetCSharpResultAt(8, 119, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1CryptoServiceProviderInTryBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderInCatchBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        {
            try { }
            catch (Exception) { var sha1 = new SHA1CryptoServiceProvider(); }
            finally { }
        }
    }
}",
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderInFinallyBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        private void TestMethod()
        {
            ...
            finally { var sha1 = new SHA1CryptoServiceProvider(); }
        }
    }
}",
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderAwaitShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
using System.Threading.Tasks;
namespace TestNamespace
{
    class TestClass
    {
        private async Task TestMethod()
        {
            await Task.Run(() => { new SHA1CryptoServiceProvider(); });
        }
        private async void TestMethod2()
        {
            await TestMethod();
        ...
        [Fact]
        public void UseSHA1CryptoServiceProviderWithDelegateShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    ...
    {
        delegate void Del();
        Del d = delegate () { new SHA1CryptoServiceProvider(); };
    }
}",
        ...
        [Fact]
        public void UseSHA1ManagedShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
...
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1ManagedWithGetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
   class TestClass1
    {
        public SHA1Managed GetSHA1
        {
            get { return new SHA1Managed(); }
        }
    }
}",
            GetCSharpResultAt(9, 26, CA5354RuleName, CA5354Message));
        ...
        [Fact]
        public void UseSHA1ManagedWithSetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1Managed privateSHA1;
        public SHA1Managed GetSHA1
        {
            set
            {
                if (value == null)
                    privateSHA1 = new SHA1Managed();
                else
                    privateSHA1 = value;
            }
        }
        ...
        [Fact]
        public void UseSHA1ManagedWithFieldInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1Managed privateSHA1 = new SHA1Managed();
    }
}",
            GetCSharpResultAt(7, 35, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1ManagedWithListCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        List<SHA1Managed> SHA1List = new List<SHA1Managed>() { new SHA1Managed() };
    }
}",
            GetCSharpResultAt(8, 64, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1ManagedWithArrayCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1Managed[] SHA1List = new SHA1Managed[] { new SHA1Managed() };
    }
}",
            GetCSharpResultAt(7, 54, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1ManagedWithDictionaryInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        Dictionary<int, SHA1Managed> SHA1List = new Dictionary<int, SHA1Managed>() { { 1, new SHA1Managed() } };
    }
}",
            GetCSharpResultAt(8, 91, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1ManagedInTryBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1ManagedInCatchBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        {
            try { }
            catch (Exception) { var sha1 = new SHA1Managed(); }
            finally { }
        }
    }
}",
        ...
        [Fact]
        public void UseSHA1ManagedInFinallyBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        private void TestMethod()
        {
            ...
            finally { var sha1 = new SHA1Managed(); }
        }
    }
}",
            GetCSharpResultAt(12, 34, CA5354RuleName, CA5354Message));
        ...
        [Fact]
        public void UseSHA1ManagedAwaitShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
using System.Threading.Tasks;
namespace TestNamespace
{
    class TestClass
    {
        private async Task TestMethod()
        {
            await Task.Run(() => { new SHA1Managed(); });
        }
        private async void TestMethod2()
        {
            await TestMethod();
        ...
        [Fact]
        public void UseSHA1ManagedWithDelegateShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    ...
    {
        delegate void Del();
        Del d = delegate () { new SHA1Managed(); };
    }
}",
            GetCSharpResultAt(8, 31, CA5354RuleName, CA5354Message));
        }
        ...
        [Fact]
        public void UseSHA1CngShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
...
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CngWithGetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
   class TestClass1
    {
        public SHA1Cng GetSHA1
        {
            get { return new SHA1Cng(); }
        }
    }
}",
            GetCSharpResultAt(9, 26, CA5354RuleName, CA5354Message));
        ...
        [Fact]
        public void UseSHA1CngWithSetShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CngWithFieldInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1Cng privateSHA1 = new SHA1Cng();
    }
}",
            GetCSharpResultAt(7, 31, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CngWithListCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        List<SHA1Cng> SHA1List = new List<SHA1Cng>() { new SHA1Cng() };
    }
}",
            GetCSharpResultAt(8, 56, CA5354RuleName, CA5354Message));
        }
        
        [Fact]
        public void UseSHA1CngWithArrayCollectionInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        SHA1Cng[] SHA1List = new SHA1Cng[] { new SHA1Cng() };
    }
}",
            GetCSharpResultAt(7, 46, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1CngWithDictionaryInitializerShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Collections.Generic;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        Dictionary<int, SHA1Cng> SHA1List = new Dictionary<int, SHA1Cng>() { { 1, new SHA1Cng() } };
    }
}",
            GetCSharpResultAt(8, 83, CA5354RuleName, CA5354Message));
        } 
        
        [Fact]
        public void UseSHA1CngInTryBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CngInCatchBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        {
            try { }
            catch (Exception) { var sha1 = new SHA1Cng(); }
            finally { }
        }
    }
}",
        ...
        [Fact]
        public void UseSHA1CngInFinallyBlockShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System;
using System.Security.Cryptography;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CngAwaitShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
using System.Threading.Tasks;
namespace TestNamespace
{
    class TestClass
    {
        ...
        [Fact]
        public void UseSHA1CngWithDelegateShouldGenerateDiagnostic()
        {
            VerifyCSharp(@"
using System.Security.Cryptography;
namespace TestNamespace
...
End Module",
        ...
        private readonly string CA5354Message = DesktopAnalyzersResources.DoNotUseSHA1;

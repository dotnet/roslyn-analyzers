...
namespace Microsoft.ApiDesignGuidelines.Analyzers
{
    ...
    public class IdentifiersShouldNotContainTypeNames : DiagnosticAnalyzer
    {
        ...
        public override void Initialize(AnalysisContext analysisContext)
        {
            ...
            analysisContext.RegisterSymbolAction(symbolContext =>
            {
                if (IsObjectEqualsOverride(symbolContext.Symbol))
                {
        ...
        {
            // Check if member contains type name 
        ...
        private static bool IsObjectEqualsOverride(ISymbol symbol)
        {
            return symbol.Name == "Equals" && symbol is IMethodSymbol && symbol.IsOverride;
        }
    }
}
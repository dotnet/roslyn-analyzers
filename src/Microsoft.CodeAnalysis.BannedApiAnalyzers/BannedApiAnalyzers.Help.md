...
The following file has to be added to any project referencing this package to enable analysis:
...
To add a symbol to the banned list, just add an entry in the format below to the BannedSymbols.txt (Description Text will be displayed as description in diagnostics, which is optional):

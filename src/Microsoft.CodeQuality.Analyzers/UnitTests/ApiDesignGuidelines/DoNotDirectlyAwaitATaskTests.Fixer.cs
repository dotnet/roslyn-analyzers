            ...
            await new VerifyCS.Test
            {
                ...
                BatchFixedState =
                {
                    ...
                    ExpectedDiagnostics =
                    {
                        ...
                        // 'ConfiguredTaskAwaitable' does not contain a definition for 'ConfigureAwait' and no accessible extension method 'ConfigureAwait' accepting a first argument of type 'ConfiguredTaskAwaitable' could be found (are you missing a using directive or an assembly reference?)
                        DiagnosticResult.CompilerError("CS1061").WithSpan(9, 69, 9, 83),
                    },
                },
...
";
            ...
            await new VerifyVB.Test
            {
                ...
                BatchFixedState =
                {
                    ...
                    {
                        // 🐛 the Fix All should not be producing this invalid code
                        // 'ConfigureAwait' is not a member of 'ConfiguredTaskAwaitable'.
                        DiagnosticResult.CompilerError("BC30456").WithSpan(7, 15, 7, 83),
                    },
                },
                NumberOfFixAllIterations = 2,
            }.RunAsync();

...
");
        ...
        private void Verify(string source, string language, DiagnosticAnalyzer analyzer, string testProjectName, DiagnosticResult[] expected)
        {
            ...
            var diagnostics = GetSortedDiagnostics(sources.ToFileAndSource(), language, analyzer, null, addLanguageSpecificCodeAnalysisReference: true, projectName: testProjectName);

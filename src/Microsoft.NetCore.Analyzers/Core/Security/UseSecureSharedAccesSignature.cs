...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class UseSecureSharedAccesSignature : DiagnosticAnalyzer
    {
        ...
        internal static DiagnosticDescriptor DoNotUseAccountSASRule = new DiagnosticDescriptor(
                DiagnosticId,
                s_Title,
                s_DoNotUseAccountSASMessage,
        ...
        internal static DiagnosticDescriptor UseSharedAccessProtocolHttpsOnlyRule = new DiagnosticDescriptor(
                DiagnosticId,
                s_Title,
                s_UseSharedAccessProtocolHttpsOnlyMessage,
                DiagnosticCategory.Security,
                DiagnosticHelpers.DefaultDiagnosticSeverity,
                isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
                description: s_Description,
        ...
        internal static DiagnosticDescriptor UseContainerLevelAccessPolicyRule = new DiagnosticDescriptor(
                DiagnosticId,
                s_Title,
                s_UseContainerLevelAccessPolicyMessage,
                DiagnosticCategory.Security,
                DiagnosticHelpers.DefaultDiagnosticSeverity,
                isEnabledByDefault: DiagnosticHelpers.EnabledByDefaultIfNotBuildingVSIX,
                description: s_Description,

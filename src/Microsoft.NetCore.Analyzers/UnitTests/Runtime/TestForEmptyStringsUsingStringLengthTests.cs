...
namespace Microsoft.NetCore.Analyzers.Runtime.UnitTests
{
    public class TestForEmptyStringsUsingStringLengthTests : DiagnosticAnalyzerTestBase
    {
        ...
        {
            return GetBasicResultAt(line, column, TestForEmptyStringsUsingStringLengthAnalyzer.RuleId, MicrosoftNetCoreAnalyzersResources.TestForEmptyStringsUsingStringLengthMessage);
        }

...
End Namespace" }
        ...
        private static readonly string s_CA5350RuleTitle = MicrosoftNetFrameworkAnalyzersResources.DoNotUseWeakCryptographicAlgorithms;
        private static readonly string s_CA5351RuleTitle = MicrosoftNetFrameworkAnalyzersResources.DoNotUseBrokenCryptographicAlgorithms;

        private static readonly string s_CA5350RuleMessage = MicrosoftNetFrameworkAnalyzersResources.DoNotUseWeakCryptographicAlgorithmsMessage;
        private static readonly string s_CA5351RuleMessage = MicrosoftNetFrameworkAnalyzersResources.DoNotUseBrokenCryptographicAlgorithmsMessage;

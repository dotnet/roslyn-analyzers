...
namespace Microsoft.NetFramework.Analyzers.UnitTests
{
    public partial class ImplementSerializationConstructorsTests
    {
        ...
        internal static readonly string CA2229Message = MicrosoftNetFrameworkAnalyzersResources.ImplementSerializationConstructorsMessageCreateMagicConstructor;
        internal static readonly string CA2229MessageSealed = MicrosoftNetFrameworkAnalyzersResources.ImplementSerializationConstructorsMessageMakeSealedMagicConstructorPrivate;
        internal static readonly string CA2229MessageUnsealed = MicrosoftNetFrameworkAnalyzersResources.ImplementSerializationConstructorsMessageMakeUnsealedMagicConstructorFamily;

...
#pragma warning restore CA1054,CA1055
                                                                        ...
                                                                        string diagnosticMessageArgument)
        {
            ...
            {
                Debug.Assert(false, $"Should never reach this line. This means the symbol {symbol.Name} was not processed in this analyzer");
            }
            else
            {
                                                                        ...
                                                                        string diagnosticMessageArgument1)
        {
            ...
            {
                Debug.Assert(false, $"Should never reach this line. This means the symbol {previewSymbol.Name} was not processed in this analyzer");
            }
            else
            {
                string url = existing.url ?? DefaultURL;

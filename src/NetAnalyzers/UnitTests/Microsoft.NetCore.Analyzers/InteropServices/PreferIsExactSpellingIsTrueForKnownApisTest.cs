...
namespace Microsoft.NetCore.Analyzers.InteropServices.UnitTests
{
    public sealed class PreferIsExactSpellingIsTrueForKnownApisTest
    {
        ...
        [Fact]
        public async Task CA1839CSharpTest_AddExactSpellingOnWideRule()
        {
...
");
        ...
        [Fact]
        public async Task CA1839CSharpTest_AddSuffixAndExactSpelling()
        {
            await VerifyCS.VerifyCodeFixAsync(@"
using System.Runtime.InteropServices;
...
public class C
{
    ...
    static extern void {|#0:CharToOemBuff|}(); // should have exactSpelling and A suffix
    [DllImport(""user32.dll"", EntryPoint = ""GetWindowModuleFileName"")]
    static extern void {|#1:CustomMethodNameRename|}(); // should have exactSpelling and a suffix, name derived from attribute
}
",
                new[]{CA1839_DefaultRule(0, "CharToOemBuff"),
                CA1839_DefaultRule(1, "GetWindowModuleFileNameA")}, @"
using System.Runtime.InteropServices;
...
");
        ...
        [Fact]
        public async Task CA1839CSharpTest_ShoudHaveExactSpellingDefaultRule()
        {
            await VerifyCS.VerifyCodeFixAsync(@"
using System.Runtime.InteropServices;
...
public class C
{
    ...
    static extern void {|#0:CallMyMessageFilterCuston|}(); // should have exactSpelling true
}
",
                new[]{ CA1839_DefaultRule(0, "CharToOemA") }, @"
using System.Runtime.InteropServices;
...
");
        ...
        [Fact]
        public async Task CA1839CSharpTest_NoWarningOnValidOrUnkownImports()
        {

...
public class A
{
    public void B()
    {
        Console.WriteLine({|CA1853:new[]{ 1, 2, 3 }|});
    }
}
", @"
using System;
...
Public Class A
    Public Sub B()
        Console.WriteLine({|CA1853:{1, 2, 3}|})
    End Sub
End Class
", @"
Imports System
...
public class A
{
    public void B()
    {
        Console.WriteLine({|CA1853:new int[]{ 1, 2, 3 }|});
    }
}
", @"
using System;
...
Public Class A
    Public Sub B()
        Console.WriteLine({|CA1853:New Integer() {1, 2, 3}|})
    End Sub
End Class
", @"
Imports System
...
public class A
{
    public void B()
    {
        Console.WriteLine(string.Join("" "", {|CA1853:new[] { ""Cake"", ""is"", ""good"" }|}));
    }
}
", @"
using System;
...
Public Class A
    Public Sub B()
        Console.WriteLine(String.Join("" ""c, {|CA1853:{""Cake"", ""is"", ""good""}|}))
    End Sub
End Class
", @"
Imports System
...
public class A
{
    public void B()
    {
        Console.WriteLine(string.Join("" "", {|CA1853:new[] { ""a"", ""b"" }|} /* test comment */));
    }
}
", @"
using System;
...
public class A
{
    ...
    {
        var x = new string[] { ""a"", ""b"" };
        var y = x.Select(z => {|CA1853:new[] { ""c"" }|}.First());
    }
}
", @"
using System;
...
public class A
{
    public void B()
    {
        string y = {|CA1853:new[] { ""a"", ""b"", ""c"" }|}.First();
        Console.WriteLine(y);
    }
}
", @"
...
Public Class A
    Public Sub B()
        Dim y As String = {|CA1853:{""a"", ""b"", ""c""}|}.First()
        Console.WriteLine(y)
    End Sub
End Class
", @"

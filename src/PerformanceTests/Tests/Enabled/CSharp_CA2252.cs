...
{
    public class CSharp_CA2252
    {
        [IterationSetup]
        public static void CreateEnvironmentCA2252()
        {
...
"));
            ...
            CompilationWithAnalyzers = compilation.WithAnalyzers(ImmutableArray.Create<DiagnosticAnalyzer>(new CSharpDetectPreviewFeatureAnalyzer()));
        }
        ...
        [Benchmark]
        public async Task CA2252_DiagnosticsProduced()
        {
        ...
        public async Task CA2252_Baseline()
        {

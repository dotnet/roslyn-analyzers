...
#if NETCOREAPP
            var container = "netstandard";
#else
            var container = "mscorlib";
#endif

            string shippedText =
$@"
System.StringComparison (forwarded, contained in {container})
System.StringComparison.CurrentCulture = 0 -> System.StringComparison (forwarded, contained in {container})
System.StringComparison.CurrentCultureIgnoreCase = 1 -> System.StringComparison (forwarded, contained in {container})
System.StringComparison.InvariantCulture = 2 -> System.StringComparison (forwarded, contained in {container})
System.StringComparison.InvariantCultureIgnoreCase = 3 -> System.StringComparison (forwarded, contained in {container})
System.StringComparison.Ordinal = 4 -> System.StringComparison (forwarded, contained in {container})
System.StringComparison.OrdinalIgnoreCase = 5 -> System.StringComparison (forwarded, contained in {container})
";
            string unshippedText = $@"";
...
";
            ...
            string shippedText =
$@"
System.StringComparer (forwarded, contained in {container})
static System.StringComparer.InvariantCulture.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.InvariantCultureIgnoreCase.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.CurrentCulture.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.CurrentCultureIgnoreCase.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.Ordinal.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.OrdinalIgnoreCase.get -> System.StringComparer (forwarded, contained in {container})
static System.StringComparer.Create(System.Globalization.CultureInfo culture, bool ignoreCase) -> System.StringComparer (forwarded, contained in {container})
System.StringComparer.Compare(object x, object y) -> int (forwarded, contained in {container})
System.StringComparer.Equals(object x, object y) -> bool (forwarded, contained in {container})
System.StringComparer.GetHashCode(object obj) -> int (forwarded, contained in {container})
abstract System.StringComparer.Compare(string x, string y) -> int (forwarded, contained in {container})
abstract System.StringComparer.Equals(string x, string y) -> bool (forwarded, contained in {container})
abstract System.StringComparer.GetHashCode(string obj) -> int (forwarded, contained in {container})
System.StringComparer.StringComparer() -> void (forwarded, contained in {container})
";
            string unshippedText = $@"";

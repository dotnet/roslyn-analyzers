...
{{                                 
    ...
    public class CSharp{1}Fixer : {1}Fixer
    {{ 
...
@"      <TestAssemblies Include=""Binaries\$(Configuration)\{0}.Analyzers.UnitTests.dll"" />";
        ...
        public static string GenerateAnalyzerFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + check.Name + ".cs";
        }
        ...
        public static string GenerateCSharpAnalyzerFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + "CSharp" + check.Name + ".cs";
        }
        ...
        public static string GenerateBasicAnalyzerFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + "Basic" + check.Name + ".vb";
        }

        public static string GenerateAnalyzerTests(string analyer, string name)
        {
            return string.Format(_analyzerTestTemplate, analyer, name);
        }

        public static string GenerateAnalyzerTestsFileName(string name, string category, bool multipleDir = false)
        {
            return (multipleDir ? category + @"\" : string.Empty) + name + "Tests.cs";
        }
        ...
        public static string GenerateCodeFixFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + check.Name + ".Fixer.cs";
        }
        ...
        public static string GenerateCSharpCodeFixFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + "CSharp" + check.Name + ".Fixer.cs";
        }
        ...
        public static string GenerateBasicCodeFixFileName(CheckData check, bool multipleDir = false)
        {
            return (multipleDir ? check.Category + @"\" : string.Empty) + "Basic" + check.Name + ".Fixer.vb";
        }

        public static string GenerateCodeFixTests(string analyzer, string name)
        {
            return string.Format(_codeFixTestTemplate, analyzer, name);
        }

        public static string GenerateCodeFixTestsFileName(string name, string category, bool multipleDir = false)
        {
            return (multipleDir ? category + @"\" : string.Empty) + name + "Tests.Fixer.cs";
        }

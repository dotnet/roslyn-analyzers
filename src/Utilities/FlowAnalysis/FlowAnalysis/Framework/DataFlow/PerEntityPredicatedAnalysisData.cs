...
namespace Microsoft.CodeAnalysis.FlowAnalysis.DataFlow
{
    public abstract partial class PredicatedAnalysisData<TKey, TValue>
    {
        ...
        /// on the control flow paths where the corresonding <see cref="AnalysisEntity"/> is known to have <c>true</c> or <c>false</c> value respectively.
        /// </summary>
        protected sealed class PerEntityPredicatedAnalysisData : IDisposable
        {
            ...
            /// <summary>
            /// Analysis data for <c>true</c> value of the corresponding <see cref="AnalysisEntity"/> on which this data is predicated.
            /// <c>null</c> value indicates the corresponding <see cref="AnalysisEntity"/> can never be <c>true</c>.
            /// </summary>
            public DictionaryAnalysisData<TKey, TValue> TruePredicatedData { get; private set; }

            /// <summary>
            /// Analysis data for <c>false</c> value of the corresponding <see cref="AnalysisEntity"/> on which this data is predicated.
            /// <c>null</c> value indicates the corresponding <see cref="AnalysisEntity"/> can never be <c>false</c>.
            /// </summary>
